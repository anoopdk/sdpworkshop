...
@sdp.materialized_view(
    name="ecommerce.${var.catalog_env}.silver.silver_orders",
...
@sdp.materialized_view(
    name="ecommerce.${var.catalog_env}.silver.silver_customers",
...
sdp.create_streaming_table(
    name="ecommerce.${var.catalog_env}.silver.silver_customer_dim_scd2",
    comment="SCD Type 2 for customers. Tracks full history of changes."
)

# Then define the CDC flow
sdp.create_auto_cdc_flow(
    target="ecommerce.${var.catalog_env}.silver.silver_customer_dim_scd2",
