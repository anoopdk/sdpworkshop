# sdp-ecommerce_bronze

This folder defines all source code for the 'sdp-ecommerce_bronze' pipeline:
...
* Take a look at the sample under "sample_users_sdp_ecommerce_bronze.py" to get familiar with the syntax.
